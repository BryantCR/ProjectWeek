...
O    (1) Application includes protected route (user must be in session to view)
X    (1) Application features static content (CSS, images, JS)
O    (1) Created data must be validated (events cannot be in the past, wall posts must include content, no duplicate data, etc)
